...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "𝒀𝒐𝒖 𝒉𝒂𝒗𝒆 𝒏𝒐𝒕 𝒂𝒄𝒄𝒆𝒔𝒔 𝒚𝒆𝒕 𝒈𝒆𝒕 𝒏𝒐𝒘 𝒂𝒄𝒄𝒆𝒔𝒔 𝒇𝒓𝒐𝒎:- @MEETisLIVE06"
...
✅ Usage: /remove <userid>'''
        ...
        response = "🔐 𝐤𝐞𝐲 𝐞𝐱𝐩𝐢𝐫𝐞:- @MEETisLIVE06 ❤️."
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 600:
                ...
                full_command = f"./meet {target} {port} {time} 65"
...
Official Channel :- https://t.me/Mahakaalgaming786
'''
